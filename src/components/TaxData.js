...
const TaxData = () => {
    ...
    const ModalHandle = () => {
        ...
        addNote(note.bas, note.lta, note.hra, note.fa, note.inv, note.med, note.rent);
        ...
        <>
            ...
            {!hide ? <form className='my-2 taxCol'>
                <div className="form-group">
                    ...
                    <input type="number" className="form-control" id="bas" placeholder="Enter Basic" name="bas" autoComplete='false' onChange={onchange} value={note.bas} />
                </div>
                <div className="form-group">
                    <label htmlFor="lta">LTA</label>
                    <input type="number" className="form-control" id="lta" placeholder="Enter lta" name="lta" autoComplete='false' onChange={onchange} value={note.lta} />
                </div>
                <div className="form-group">
                    <label htmlFor="hra">HRA</label>
                    <input type="number" className="form-control" id="hra" placeholder="Enter hra" name="hra" autoComplete='false' onChange={onchange} value={note.hra} />
                </div>
                <div className="form-group">
                    <label htmlFor="fa">Food Allowance</label>
                    <input type="number" className="form-control" id="fa" placeholder="Enter fa" name="fa" autoComplete='false' onChange={onchange} value={note.fa} />
                </div>
                <div className="form-group">
                    <label htmlFor="inv">Investments</label>
                    <input type="number" className="form-control" id="inv" placeholder="Enter inv" name="inv" autoComplete='false' onChange={onchange} value={note.inv} />
                </div>
                <div className="form-group">
                    <label htmlFor="med">Medical Policy Premium</label>
                    <input type="number" className="form-control" id="med" placeholder="Enter med" name="med" autoComplete='false' onChange={onchange} value={note.med} />
                </div>
                <div className="form-group">
                    <label htmlFor="rent">Rent</label>
                    <input type="number" className="form-control" id="rent" placeholder="Enter rent" name="rent" autoComplete='false' onChange={onchange} value={note.rent} />
                </div>
                <div className="form-group my-2">
                    <label htmlFor="med">Area</label>
